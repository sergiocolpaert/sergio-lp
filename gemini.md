...
- **Lógica de Transformação:** Transparente com texto claro no topo do hero. Transiciona para `bg-[background]/60 backdrop-blur-xl` com texto na cor primária e uma borda sutil quando a rolagem passar pelo hero. Use `IntersectionObserver` ou ScrollTrigger.
